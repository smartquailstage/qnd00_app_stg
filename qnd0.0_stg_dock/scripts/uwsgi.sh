...
python manage.py collectstatic --settings=qnd00_app_stg.settings.stage --noinput 
...
uwsgi --http= 27.0.0.1:9000 --workers 9 --master --enable-threads --module qnd00_app_stg.wsgi  --ini uwsgi_stage.ini
